...
excerpt_text: A practical mental model for understanding the relationship between Supervised Fine Tuning and Reinforcement Learning.
---
...
In a nutshell: **SFT defines the behavior space, RL optimizes within that behavior space.**
